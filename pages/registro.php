...
include '../includes/conexion.php'; // para traer las organizaciones si existen

// Obtener lista de organizaciones existentes
...
<section class="formulario">
    ...
    <form action="procesar_registro.php" method="POST" id="registroForm">
        ...
        <div id="campoOrganizacion" style="display: none; margin-top: 15px;">
            ...
            <!-- Select con organizaciones existentes -->
...
// Mostrar input si elige "Nueva organización"
